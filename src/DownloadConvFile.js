...
function DownloadConvFile(Props) {
    ...
    const downloadJSONFile = () => {
        ...
        var data = new Blob([JSON.stringify(Props.data.parsedData)], {type: 'text'});
    ...
    const downloadCSVFile = () => {
        ...
        exportCSVFile(Props.data.tableRows,Props.data.parsedData,Props.data.fileName);
         ...
         {(() => {
            ...
            //console.log(parsedData);
                ...
                if(Props.data.fileType==='csv')
                    return (<button className="btn" onClick={downloadJSONFile}>
                    Download JSON
                  </button>);
                if(Props.data.fileType==='json')
                    return (<button className="btn" onClick={downloadCSVFile}>
                    Download CSV
                  </button>);
